		...
		try {
			...
			while(running) {
				...
				try { 
						...
						long sender_time = toReceive.getSenderTime();
						long current_time = System.currentTimeMillis();
						int diff = (int) (current_time - sender_time);
						System.out.println("Received " + toReceive.getMsg() + " from process " + toReceive.getSenderID() + " with delay " + diff);
